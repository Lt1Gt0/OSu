...
namespace PCI
{
    ...
    const char* GetSubclassName(uint8 classCode, uint8 subclassCode)
    {
        ...
        case 0x05:
            return MemoryControllerSubclassName(subclassCode);
        case 0x06:
            return BridgeControllerSubclassName(subclassCode);
        case 0x0E:
            return IntelligentControllerSubclassName(subclassCode);
        /* 0x14 -> 0x3C (Reserved) */
        /* 0x41 -> 0xFE (Reserved) */
        }
    ...
    const char* GetProgIFName(uint8 classCode, uint8 subclassCode, uint8 progIF)
    {
        ...
        case 0x01: // MSC
            ...
            case 0x05: // Memory Controller (To my knowledge there are no Program Interfaces provided)
                break;
            ...
            case 0x0E: // Intelligent Controller (To my knowledge there are no Program Interfaces provided)
                break;
            /* 0x14 -> 0x3C (Reserved) */
            /* 0x41 -> 0xFE (Reserved) */
        }
